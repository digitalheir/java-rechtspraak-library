package deprecated.org.crf.function.optimization;

import deprecated.org.crf.function.DerivableFunction;
...
//	}
	...
	{
		final double valueForAlphaZero = LineSearchUtilities.valueForAlpha(function, point, direction, 0);
		final double derivationForAlphaZero = LineSearchUtilities.derivationForAlpha(function, point, direction, 0);
		...
		if ((LineSearchUtilities.valueForAlpha(function, point, direction, alpha) - valueForAlphaZero) < sigma_convergenceCoefficient * alpha * derivationForAlphaZero)
		{
			...
			while ((LineSearchUtilities.valueForAlpha(function, point, direction, alpha) - valueForAlphaZero) < sigma_convergenceCoefficient * alpha * derivationForAlphaZero);
			ret = previousAlpha;
		}
		else
		{
