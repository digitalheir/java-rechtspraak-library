 ...
 *         Date: Nov 23, 2014
 */
public abstract class ExampleMain implements Runnable {
...
//	}
    ...
    public abstract List<List<? extends TaggedToken<String, String>>> loadCorpusWhereTokensAndTagsAreStrings();

    public abstract CrfFeatureGenerator<String, String> createFeatureGeneratorForGivenCorpus(Iterable<? extends List<? extends TaggedToken<String, String>>> corpus, Set<String> tags);

    public abstract FilterFactory<String, String> createFilterFactory();
