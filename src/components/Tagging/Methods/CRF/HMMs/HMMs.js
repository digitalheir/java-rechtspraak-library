    ...
    render() {
        return <div>
            ...
            <p>
                ...
                states') <F {...this.props} l="\mathbf y=\{y_t\}_{t=1}^T"/>, which are valuations
                of some random vectors <F {...this.props} l="X"/> and <F {...this.props} l="Y"/> respectively, and <F {...this.props}
                l="V = X\cup Y"/>.
            ...
            <p>
                ...
                looping over all <F {...this.props} l="\mathbf y\in Y"/> and selecting <F {...this.props} l="\mathbf y^*\in Y"/> with the
                highest likelihood.
            </p>
