    ...
    render() {
        return <div>
            <p>
                ...
                we model a linear sequence of observations <F l="\mathbf x=\{\mathbf x_t\}_{t=1}^T"/> that are assumed
            ...
            <ol>
                ...
                <li>any input variable (or <em>observation</em>) <F l="\mathbf x_t"/> only depends on the label <F l="\mathbf y_t"/>;
            ...
            <p>
                To find plausible values of <F l="p(\mathbf x_t|\mathbf y_t)"/> and <F l="p(\mathbf y_t|\mathbf y_{t-1})"/>, we
