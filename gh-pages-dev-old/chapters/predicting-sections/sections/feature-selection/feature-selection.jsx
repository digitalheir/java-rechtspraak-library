...
const F = require('../../../../math.jsx');
const FigureInfoText = require('./figure-info-tf-idf/figure-info-tf-idf.jsx');
const TitleTfIdfFigure = require('./figure-title-tf-idf/figure-title-tf-idf.jsx');
const TitleTfIdfFigurePerSection = require('./figure-section-title-tf-idf/figure-section-tf-idf.jsx');
const WordCountFig = require('./figure-word-count-title/figure-title-word-count.jsx');
